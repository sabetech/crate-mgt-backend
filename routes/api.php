...
Route::group(["prefix" => "v1"], function () {
    ...
    Route::group(["middleware" => "auth:sanctum"], function () {
        ...
        Route::group(["prefix" => "stocks"], function () {
            ...
            Route::get("receivable-log", [\App\Http\Controllers\API\ProductController::class, 'receivableLogs']);
            Route::get("inventory-transaction", [\App\Http\Controllers\API\ProductController::class, 'inventoryHistory']);
